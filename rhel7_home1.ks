...
# Network information
network  --bootproto=static --ip=192.168.4.10 --netmask=255.255.255.0 --gateway=192.168.4.1 --nameserver=192.168.4.1,208.67.222.222 --device=eno1 --ipv6=ignore --activate
network  --hostname=home1.gshome.lan
...
part pv.123 --fstype="lvmpv" --ondisk=sda --size=70000
...
logvol /var/log  --fstype="xfs" --size=10000 --name=var_log --vgname=vg01
