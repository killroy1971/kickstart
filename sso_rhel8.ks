...
# Network information
network  --bootproto=static --device=eth0 --gateway=192.168.4.1 --ip=192.168.4.25 --nameserver=192.168.4.22 --netmask=255.255.255.0 --noipv6 --activate
network  --hostname=sso.gshome.lan

repo --name="Server-HighAvailability" --baseurl=file:///run/install/repo/addons/HighAvailability
repo --name="Server-ResilientStorage" --baseurl=file:///run/install/repo/addons/ResilientStorage
# Root password
rootpw --iscrypted $6$gIuOjG5Tiqx4DzFx$e9UD7j4341qbAbQ3fX8YrCNzXc4gvLs/IT3T1h2yoXiStyVdgEnkIe5oJGDn6ianXCvzwUzXfqQwozVWgpviD0
# System services
services --enabled="chronyd"
# System timezone
timezone America/New_York --isUtc
user --groups=wheel --name=glenn --password=$6$WDgDIHqtRf4OvheS$MVUhXL01mXQOcK5DSkJNvd4OKquuWScMhEAMll1cz599f0cUG5W8gMvMJWPGI7b6nfpUVoVWcBwVM6vO.Cm3Z1 --iscrypted --gecos="Glenn H. Snead"
# System bootloader configuration
bootloader --location=mbr --boot-drive=vda
# Partition clearing information
clearpart --none --initlabel
# Disk partitioning information
part pv.253 --fstype="lvmpv" --ondisk=vda --size=100492
part /boot --fstype="xfs" --ondisk=vda --size=1907
volgroup vg01 --pesize=4096 pv.253
