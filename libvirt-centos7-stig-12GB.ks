...
logvol /var/log  --fstype="xfs" --size=500 --name=var_log --vgname=vg01
logvol /opt  --fstype="xfs" --size=1536 --name=opt --vgname=vg01
logvol /var/log/audit  --fstype="xfs" --size=256 --name=var_log_audit --vgname=vg01
