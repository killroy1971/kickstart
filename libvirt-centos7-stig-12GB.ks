...
part /boot --fstype="xfs" --ondisk=vda --size=256 --fsoptions=defaults,noexec,nosuid,nodev
part pv.235 --fstype="lvmpv" --ondisk=vda --size=12031
volgroup vg01 --pesize=4096 pv.235
logvol swap  --fstype="swap" --size=256 --name=swap --vgname=vg01
...
logvol /tmp  --fstype="xfs" --size=1024 --name=tmp --vgname=vg01 --fsoptions=defaults,noexec,nosuid,nodev
logvol /home  --fstype="xfs" --size=500 --name=home --vgname=vg01 --fsoptions=defaults,noexec,nosuid,nodev
logvol /var  --fstype="xfs" --size=2048 --name=var --vgname=vg01 --fsoptions=defaults,noexec,nosuid,nodev
