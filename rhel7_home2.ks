...
# Network information
network  --bootproto=static --ip=192.168.4.22 --netmask=255.255.255.0 --gateway=192.168.4.1 --nameserver=192.168.4.1 --device=eno1 --ipv6=ignore --activate
network  --hostname=home2.gshome.lan
