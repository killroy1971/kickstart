...
logvol /var/log/audit  --fstype="xfs" --size=1024 --name=var_log_audit --vgname=vg01 --fsoptions=defaults,noexec,nodev,nosuid
logvol /var/log  --fstype="xfs" --size=2048 --name=var_log --vgname=vg01 --fsoptions=defaults,noexec,nodev,nosuid
logvol /home  --fstype="xfs" --size=1024 --name=home --vgname=vg01 --fsoptions=defaults,noexec,nodev,nosuid
logvol /var  --fstype="xfs" --size=4096 --name=var --vgname=vg01 --fsoptions=defaults,noexec,nodev,nosuid
...
logvol /tmp  --fstype="xfs" --size=4096 --name=tmp --vgname=vg01 --fsoptions=defaults,noexec,nodev,nosuid
