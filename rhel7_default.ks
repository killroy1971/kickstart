...
# Network information
network  --bootproto=static --ip=192.168.4.210 --netmask=255.255.255.0 --gateway=192.168.4.1 --nameserver=192.168.4.1,208.67.222.222 --device=eth0 --ipv6=ignore --activate
