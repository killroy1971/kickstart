...
# Network information
network  --bootproto=static --device=enp2s0 --gateway=192.168.4.1 --ip=192.168.4.13 --nameserver=208.67.222.222,192.168.4.10 --netmask=255.255.255.0 --noipv6 --activate
network  --bootproto=static --device=enp4s0 --gateway=192.168.5.1 --ip=192.168.5.13 --netmask=255.255.255.0 --noipv6 --activate
network  --hostname=rhev02.ghsome.lan
