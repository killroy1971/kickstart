...
# Network information
network  --bootproto=static --ip=192.168.4.24 --netmask=255.255.255.0 --gateway=192.168.4.1 --nameserver=192.168.4.10 --device=ens192 --ipv6=ignore --activate
network  --hostname=home4.gshome.lan
